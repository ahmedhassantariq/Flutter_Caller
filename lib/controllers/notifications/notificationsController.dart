...
import 'package:caller/controllers/chat/chat_services.dart';
import 'package:firebase_messaging/firebase_messaging.dart';
import 'package:flutter/material.dart';

import '../../pages/chat/videoCall/videoCallReceive.dart';
    ...
    if(message.data['type']== 'call' && receivedAction.buttonKeyPressed.toString() == 'accept'){
      Navigator.push(
          ...
          builder: (context) => FutureBuilder(
            future: ChatServices().getUser(message.data['sender'].toString()),

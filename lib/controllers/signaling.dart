...
class WebRtcManager {
  ...
  Future<String> createRoom(RTCVideoRenderer localRenderer,RTCVideoRenderer remoteRenderer, bool isScreen) async {
    if(isScreen){
      await openScreenMedia(localRenderer, remoteRenderer);
    } else {
  ...
  Future<void> joinRoom(String roomId,RTCVideoRenderer localVideo, RTCVideoRenderer remoteVideo, bool isScreen) async {
    if(isScreen){
      await openScreenMedia(localVideo, remoteVideo);
    } else {
  ...
  Future<void> openScreenMedia(RTCVideoRenderer localVideo, RTCVideoRenderer remoteVideo) async {

...
class _VideoCallSendState extends State<VideoCallSend> {
  ...
  sendInvite() async{
    roomId = await signaling.createRoom(_localRenderer,_remoteRenderer, widget.isScreen);
    // "ROOM ID"
    setState(() {});
  }
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            roomId!.isNotEmpty ? IconButton(icon: const Icon(Icons.copy), onPressed:(){copyRoomID();} , color: Colors.white): const SizedBox(),
